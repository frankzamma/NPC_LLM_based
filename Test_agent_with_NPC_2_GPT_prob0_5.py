...
agent.model.load_state_dict(torch.load('./Results/Architecture2/GPT/Training/2025_02_09_09_19_55_217783/model_GPT_2.pth'))


dir = "./Results/Architecture2/GPT/Testing/Prob" + str(PROB)
